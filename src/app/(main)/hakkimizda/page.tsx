...
{/* PAGE HERO */}
      <section className="bg-slate-900 relative text-white py-24 sm:py-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center animate-fade-in">
          <h1 className="font-heading text-4xl sm:text-5xl font-extrabold mb-4 tracking-tight">Hakkımızda</h1>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <span className="text-orange-400 font-bold text-sm uppercase tracking-widest mb-2 block">Biz Kimiz?</span>
            ...
            <div className="grid sm:grid-cols-2 gap-6 pt-6">
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                <div className="w-12 h-12 bg-orange-50 text-orange-400 rounded-xl flex items-center justify-center mb-4">
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 z-20 flex items-center gap-4 animate-float">
              <div className="w-14 h-14 bg-brand-navy rounded-full flex items-center justify-center text-orange-400">
